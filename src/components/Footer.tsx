  ...
  return (
    <footer className="mx-96 mt-32">
      ...
      <div className="flex justify-between">
        <p className="dark:text-gray-200 text-sm mt-3 max-w-sm">
          I am Eduardo Cardoso, a{" "}
          <span className="font-bold">front-end developer</span> with a genuine
          passion for clean and modern design.
        </p>
        <div className="flex gap-3 mt-5">
          ...
          <Link
            href={"https://www.linkedin.com/in/eduardo-cardoso-46695a238/"}
            target="_blank"
          >
            <SiLinkedin
              className="text-black dark:text-white"
